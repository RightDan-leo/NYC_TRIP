  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6 px-4">
      ...
      <div className="bg-gradient-to-br from-red-50 to-orange-50 rounded-2xl p-5 border border-red-100">
        <h3 className="text-base font-bold text-red-800 mb-3">🌶️ 四川人纽约生存指南</h3>

        <div className="space-y-3 text-xs text-slate-700">
          <div>
            <h4 className="font-semibold text-red-700 mb-1">语言自救锦囊</h4>
          ...
          <div>
            <h4 className="font-semibold text-red-700 mb-1">支付攻略</h4>
            <ul className="space-y-1 ml-3">
          ...
          <div>
            <h4 className="font-semibold text-red-700 mb-1">小费指南</h4>
            <ul className="space-y-1 ml-3">
      ...
      <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-2xl p-5 border border-amber-100">
        <h3 className="text-base font-bold text-amber-800 mb-3">⚠️ 安全提醒</h3>

        <div className="space-y-3 text-xs text-slate-700">
          <div>
            <h4 className="font-semibold text-amber-700 mb-1">时代广场</h4>
            <ul className="space-y-1 ml-3">
          ...
          <div>
            <h4 className="font-semibold text-amber-700 mb-1">地铁</h4>
            <ul className="space-y-1 ml-3">
          ...
          <div>
            <h4 className="font-semibold text-amber-700 mb-1">通用</h4>
            <ul className="space-y-1 ml-3">
              <li>全程使用手机 NFC 支付</li>
      ...
      <div className="md:col-span-2">
        <h3 className="text-base font-bold text-slate-800 mb-3 px-1">🍽️ 推荐餐厅（按辣度排序 🌶️）</h3>
